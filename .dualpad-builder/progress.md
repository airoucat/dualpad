...
- `S-DP5-MIXED-INPUT / I-P shadow evidence slice completed`：
  ...
  - 首轮 canonical Phase 8 在所有 runtime/治理检查通过后，仅因 `xmake.lua` 已进入 DocGen provenance、而 4 个 generated docs 尚未提交新 hash `ff99f8cd42e40575` 停止；提交预期纯 hash 更新后，clean-HEAD Phase 8 全部 exit 0。
...
## 2026-07-12 16:50:00 +08:00

- `S-DP5-MIXED-INPUT / I-0 availability A/B partial live sample`：
  - matching build `76895173dda7 / Skyrim 1-5-97-0` 完成首轮实机采样；用户明确报告 gameplay `W` 与鼠标攻击均无反应，因此 KBM gameplay 行为继续 FAIL，未宣称修复。
