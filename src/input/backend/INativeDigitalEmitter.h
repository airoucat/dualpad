...
namespace dualpad::input::backend
{
    ...
    class INativeDigitalEmitter
    {
    public:
        virtual ~INativeDigitalEmitter() = default;
        // In the poll-owned ButtonEvent mainline, Emit() is a bookkeeping edge
        ...
        // exports semanticDownMask/current-state to the upstream gamepad hook.
