...
namespace dualpad::haptics
{
    struct HapticsConfig
    {
        ...
        bool enableStateTrackHitTruthTrigger{ true };
        bool enableStateTrackWeaponSwingTruthTrigger{ true };
        bool enableStateTrackShoutLiveOutput{ false };
        ...
        bool enableStateTrackFootstepTruthAttack{ true };
        bool enableStateTrackFootstepTextureRenderer{ true };
        ...
        bool enableFootstepAudioModifierLivePatch{ true };
        bool enableFootstepTruthSessionLivePatch{ true };
        bool enableFootstepRecentModifierMemory{ true };
        bool enableFootstepTruthBridgeShadow{ true };
        std::uint32_t stateTrackFootstepPatchLeaseUs{ 140000 };
        std::uint32_t footstepRecentModifierMemoryMaxAgeUs{ 650000 };
